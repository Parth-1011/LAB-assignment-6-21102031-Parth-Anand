...
student_data(student_id="21102031")
student_data(student_id="21102031", student_name="Parth Anand")
student_data(student_id="21102031", student_name="Parth Anand", student_class="1st Year")
print()
